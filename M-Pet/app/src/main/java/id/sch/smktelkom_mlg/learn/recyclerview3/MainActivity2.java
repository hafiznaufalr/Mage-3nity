...
import id.sch.smktelkom_mlg.learn.recyclerview3.adapter.HotelAdapter2;
...
public class MainActivity2 extends AppCompatActivity implements HotelAdapter2.IHotelAdapter {
    ...
    public static final String HOTEL2 = "hotel";
    public static final int REQUEST_CODE_ADD = 88;
    public static final int REQUEST_CODE_EDIT = 99;

    int itemPos;

    ArrayList<Hotel2> mList = new ArrayList<>();
    HotelAdapter2 mAdapter;
    ArrayList<Hotel2> mListAll = new ArrayList<>();
    boolean isFiltered;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new HotelAdapter2(this, mList);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_ADD && resultCode == RESULT_OK) {
            Hotel2 hotel = (Hotel2) data.getSerializableExtra(HOTEL2);
            mList.add(hotel);
    ...
    private void fillData() {
        ...
        String[] arDetail = resources.getStringArray(R.array.place_details2);
        ...
        for (int i = 0; i < arJudul.length; i++) {
            mList.add(new Hotel2(arJudul[i], arDeskripsi[i], arDetail[i], arLokasi[i], arFoto[i]));
    ...
    private void doFilter(String mQuery) {
        ...
        if (mQuery == null || mQuery.isEmpty()) {
            ...
            for (int i = 0; i < mListAll.size(); i++) {
                Hotel2 hotel = mListAll.get(i);
                if (hotel.judul2.toLowerCase().contains(mQuery) ||
                        hotel.deskripsi2.toLowerCase().contains(mQuery) ||
                        hotel.lokasi2.toLowerCase().contains(mQuery)) {
                    mList.add(hotel);
    ...
    public void doClick(int pos) {
        Intent wintent = new Intent(this, DetailActivity2.class);
        wintent.putExtra(HOTEL2, mList.get(pos));
    ...
    public void doShare(int pos) {
        ...
        if (mapIntent.resolveActivity(getPackageManager()) != null) {
            ...
            Toast.makeText(MainActivity2.this, "Google Maps Belum Terinstal. Install Terlebih dahulu.",
